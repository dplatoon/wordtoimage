    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              <br />
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Remover</span>
            </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
              {[
                ...
                { icon: Download, label: 'PNG Download', color: 'text-primary' },
                { icon: Sparkles, label: 'AI Precision', color: 'text-accent' },
              ].map((item) => (
                <div key={item.label} className="flex flex-col items-center p-4 rounded-xl bg-secondary/30 border border-border">
      ...
      <section className="py-16 bg-secondary/20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-foreground mb-12">How Background Removal Works</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: '1', title: 'Upload Your Image', desc: 'Drag and drop or click to select your image. Supports PNG, JPG, and WebP formats up to 10MB.', color: 'bg-primary' },
              { step: '2', title: 'AI Background Removal', desc: 'Our advanced AI analyzes your image and precisely identifies the subject to remove the background.', color: 'bg-accent' },
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-foreground mb-12">Why Choose Our AI Background Remover?</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="p-8 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20 max-w-3xl mx-auto text-center">
            <CardContent className="p-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/text-to-image" className="inline-flex items-center justify-center px-6 py-3 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 transition-colors font-medium">
                  Text to Image Generator
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
                <Link to="/ai-enhance" className="inline-flex items-center justify-center px-6 py-3 border border-border rounded-xl hover:bg-secondary transition-colors font-medium text-foreground">
                  AI Image Enhancer
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Link>
              </div>
