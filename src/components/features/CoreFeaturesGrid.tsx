...
export const CoreFeaturesGrid = () => {
  ...
  return (
    <section id="ai-features" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {primaryFeatures.map((feature, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-indigo-600 font-semibold text-sm" aria-label={`Feature metric: ${feature.stats}`}>
                  {feature.stats}
                </span>
        ...
        >
          <div className="text-center mb-12">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Advanced Features for Power Users</h3>
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-purple-600 font-medium text-xs" aria-label={`Feature metric: ${feature.stats}`}>
                      {feature.stats}
                    </span>
                  </div>
                </div>
