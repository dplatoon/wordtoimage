  ...
  return (
    ...
    >
      <div className="flex items-center justify-center h-10 w-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg shadow-md group-hover:shadow-lg transition-shadow">
        <Wand className="h-6 w-6 text-white stroke-[2]" aria-hidden="true" />
      </div>
      <div className="flex items-center space-x-1">
        <span className="font-poppins font-bold text-xl md:text-2xl text-gray-900 tracking-tight">Word</span>
        <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-blue-600 stroke-[2]" aria-hidden="true" />
        <span className="font-poppins font-bold text-xl md:text-2xl text-gray-900 tracking-tight">Image</span>
      </div>
    </Link>
  );
};
