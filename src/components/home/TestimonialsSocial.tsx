...
const TestimonialsSocial = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-violet-50 via-white to-indigo-50">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <Quote className="w-8 h-8 text-violet-500 opacity-20" />
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-xs text-violet-600">{testimonial.company}</div>
                </div>
              </div>
            </div>
          ))}
