...
export const OptimizedHero = () => {
  return (
    <section id="hero" className="relative flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 pt-20 pb-12 sm:pt-28 sm:pb-20">
      <div className="max-w-4xl mx-auto px-4 text-center text-white">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
          ...
          <span className="block mt-2 text-2xl sm:text-3xl font-medium text-cyan-300">with AI</span>
        </h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Link 
            to="/text-to-image"
            className="w-full sm:w-auto inline-flex items-center justify-center bg-cyan-500 hover:bg-pink-500 text-white font-bold px-8 py-3 rounded-lg shadow-lg transform hover:scale-105 transition"
          >
            Start Creating Now
          ...
          <Link 
            to="/examples"
            className="w-full sm:w-auto inline-flex items-center justify-center border-2 border-white text-white hover:bg-white hover:text-gray-900 font-semibold px-8 py-3 rounded-lg transform hover:scale-105 transition"
          >
            See Examples
