...
export const InfoAlert = ({ usingServerKey = false }: InfoAlertProps) => (
  <Alert variant="default" className="mb-4 bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
    ...
    <AlertDescription className="text-gray-700">
      {usingServerKey ? (
        "Generate high-quality, photorealistic images powered by OpenAI's DALL-E 3. Our server is handling API requests for you."
      ) : (
        <>
