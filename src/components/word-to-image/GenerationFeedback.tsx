...
export function GenerationFeedback({ isGenerating, generationTime }: GenerationFeedbackProps) {
  return (
    <>
      ...
      {isGenerating && (
        <div 
          className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 animate-fade-in"
          role="status"
          aria-live="polite"
        >
      ...
      {generationTime && (
        <div 
          className="mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200 animate-fade-in"
          role="status"
          aria-live="polite"
        >
