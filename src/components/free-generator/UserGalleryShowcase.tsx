...
interface UserGalleryShowcaseProps {
  userImages: Array<{
    url: string;
    prompt: string;
    style?: string;
...
export const UserGalleryShowcase = ({ userImages }: UserGalleryShowcaseProps) => {
              ...
              <div className="relative">
                <ImageSEO
                  ...
                  structuredData={{
                    ...
                    creator: image.isUserGenerated ? "Community User" : "WordToImage Showcase",
                    keywords: [image.style, image.category, 'AI art'],
