...
export const TemplateGalleryHero = () => {
  return (
    <section className="relative mb-12 bg-gradient-to-br from-brand-purple/5 via-blue-50/30 to-pink-50/20 rounded-2xl p-8 md:p-12 overflow-hidden animate-fade-in">
      ...
      <div className="relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 font-space leading-tight animate-fade-in" style={{ animationDelay: '0.3s' }}>
            AI Template Gallery
          </h1>
          
          <p className="text-lg md:text-xl text-brand-slate-600 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.4s' }}>
